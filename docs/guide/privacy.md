...
CCX Desktop 的 GitHub Release 产物提供 SHA256 与 Sigstore checksums 校验；Windows GitHub 安装器使用 SignPath Foundation 进行代码签名。Microsoft Store 版由 Store 上架流程处理签名。代码签名用于帮助用户验证应用来源和完整性，不代表 CCX 项目收集用户数据。
