...
export type AgentProvider = 'ccx' | 'deepseek' | 'mimo' | 'compshare' | 'runapi' | 'tencent-lkeap' | 'kimi' | 'kimi-code' | 'volc-ark' | 'qianfan' | 'originrouter' | 'glm' | 'minimax' | 'dashscope' | 'openrouter' | 'modelscope' | 'opencode-zen' | 'opencode-go' | 'openai'
