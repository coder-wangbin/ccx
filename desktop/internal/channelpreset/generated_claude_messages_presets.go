...
func generatedClaudeMessagesTargetConfigs() map[string]channelTargetConfig {
	return map[string]channelTargetConfig{
		...
		"mimo":          channelTargetConfig{ModelMapping: map[string]string{"fable": "mimo-v2.5-pro", "haiku": "mimo-v2.5-pro", "opus": "mimo-v2.5-pro", "sonnet": "mimo-v2.5-pro"}, ReasoningParamStyle: "reasoning", PassbackReasoningContent: true, NormalizeSystemRoleToTopLevel: true, NoVisionModels: []string{"mimo-v2.5-pro"}, VisionFallbackModel: "mimo-v2.5", RateLimitRPM: 80},
