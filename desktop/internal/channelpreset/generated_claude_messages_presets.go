...
func generatedClaudeMessagesTargetConfigs() map[string]channelTargetConfig {
	return map[string]channelTargetConfig{
		...
		"opencode-go":   channelTargetConfig{ModelMapping: map[string]string{"fable": "minimax-m3", "haiku": "minimax-m2.7", "opus": "minimax-m3", "sonnet": "minimax-m3"}, ReasoningMapping: map[string]string{"fable": "max", "haiku": "high", "opus": "max", "sonnet": "max"}, AuthHeader: "x-api-key", NormalizeSystemRoleToTopLevel: true},
